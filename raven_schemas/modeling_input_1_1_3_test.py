...
@pytest.fixture
def valid_1_1_3_modeling_json():
    with open(
        PACKAGE_DIR / "schemas/modeling_input_1_1_3_sample_valid.json"
    ) as modeling_input:
...
def test_valid_roof_material_combination(
    valid_1_1_3_modeling_json,
    roofMaterial: Optional[str],
):
    valid_roofMaterial = roofMaterial

    valid_1_1_3_modeling_json["roofMaterial"] = valid_roofMaterial

    validate.validate_json_single_version(
        valid_1_1_3_modeling_json, "modeling_input", "1.1.3"
    )
